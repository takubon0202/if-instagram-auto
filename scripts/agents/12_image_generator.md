...
**テキストオーバーレイ機能により、完成した投稿画像を出力。**

## 設計思想: 統合アプローチ v4.0

| 項目 | 担当 | 説明 |
|------|------|------|
| 背景画像 | Gemini API | アニメイラスト（テキスト・UI要素なし） |
| テキスト | Pillow | 縁取り付きテキストオーバーレイ |
| 出力 | 統合 | 完成した投稿画像（1080x1350） |

### 処理フロー
1. Gemini APIでアニメ背景画像を生成
2. Pillowでテキストオーバーレイを追加（縁取り付き）
3. 完成画像を保存（4:5比率 / 1080x1350）
